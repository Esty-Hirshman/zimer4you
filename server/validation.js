...
exports.isSigninValuesValid = function (values){
    const errorMessages = {};
 ...
 exports.isLoginValuesValid = function(values){
    const errorMessages = {};
    const errEmail = checkEmail(values.email);
    if (errEmail != null) errorMessages.email = errEmail;
    const errPassword = checkPassword(values.password);
  ...
  exports.isOwnerSigninValuesValid  = function(values){
    const errorMessages = {};
  ...
  exports.isContactValuesValid =function(values){
    const errorMessages = {};
    const errname = checkName(values.name);
    if (errname != null) errorMessages.name = errname;
    const errEmail = checkEmail(values.email);
  ...
  exports.isAddZimerValuesValid = function(values){
    const errorMessages = {};
    const errname = checkName(values.name);
    if (errname != null) errorMessages.name = errname;
    const errPhone = checkPhoneNumber(values.phone);
